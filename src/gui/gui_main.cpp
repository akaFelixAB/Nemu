// Dear ImGui: application for SDL3 + OpenGL
...
int main(int, char**) {
    ...
    ImFont* font = io.Fonts->AddFontFromFileTTF("../assets/fonts/PixelifySans-Regular.ttf", 20.0f, nullptr);
    ...
    // GAME !! remove after testing
    Bus bus{};
    bus.cpu.reset();
    Debugger debugger(&bus, bus.cpu.get_lookup());
...
#endif
    {
        ...
        ImGui::Begin("Nemu", nullptr, dockspace_flags);
        ImGui::PopStyleVar(2);

        ImGuiID dockspace_id = ImGui::GetID("NemuDockSpace");
        ImGui::DockSpace(dockspace_id, ImVec2(0.0f, 0.0f),
                         ImGuiDockNodeFlags_None);

        if (show_debug_window) {
            debugger.draw_window("Debugger");
        }
